...
public class FloatingButtonConfig {
    ...
    private static final String KEY_AUTO_START_LAUNCHED = "auto_start_launched"; 
    private static final String KEY_DOCK_DRAGGABLE = "dock_draggable";
    private static final String KEY_DOCK_BEHAVIOR = "dock_behavior"; 
    private static final String KEY_DOCK_HIDE_TIMEOUT = "dock_hide_timeout"; 
    ...
    private static final int DEFAULT_BACKGROUND_ALPHA = 128; 
    private static final int DEFAULT_ICON_COLOR = 0xFFFFFF; 
    private static final int DEFAULT_ICON_ALPHA = 255; 
    private static final int DEFAULT_ICON_GAP = 8; 
    private static final int DEFAULT_ICON_PADDING = 0; 
    private static final int DEFAULT_POSITION_MARGIN_X = 16; 
    private static final int DEFAULT_POSITION_MARGIN_Y = 16; 
    ...
    public static int getDockHideTimeout(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        return prefs.getInt(KEY_DOCK_HIDE_TIMEOUT, 5000); 
    }
}
